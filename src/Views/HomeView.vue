        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <form class="d-none d-sm-block">
                 ...
                 <div class="inline-icon-menu d-none d-md-flex align-items-center ms-2 ">
                    ...
                    <a href="#" class="icon-btn" title="Tìm kiếm">
        ...
        <div class="row">
                        ...
                        <ul class="nav flex-column g-2">
                            ...
                            <li class="nav-item mb-2">
                                <a class="nav-link d-flex align-items-center p-2" href="#">
                                    ...
                                    <span class="text-dark">Khám phá</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item mb-2">
                                <a class="nav-link d-flex align-items-center p-2" href="#">
                                    ...
                                    <span class="text-dark">Tin nhắn</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item mb-2">
                                <a class="nav-link d-flex align-items-center p-2" href="#"
                                    ...
                                    <span class="text-dark">Tạo bài viết</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item mt-2">
                                <router-link :to="{ name: 'Profile' }" class="nav-link d-flex align-items-center p-2">
                                    ...
                                    <span class="text-dark">Trang cá nhân</span>
                                </router-link>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-7">
                ...
                <div v-for="post in posts" :key="post.id" class="card mb-4">
                    ...
                    <div class="post-image position-relative" @touchstart.passive="onTouchStart($event, post)" @touchend.passive="onTouchEnd($event, post)">
                        <img :src="(post.images && post.images.length) ? post.images[(imageIndex[post.id] || 0)] : post.image" class="post-image w-100" alt="post image" />

                        <button v-if="post.images && post.images.length > 1" class="carousel-prev" @click="prevImage(post)" aria-label="Previous image">‹</button>
                        <button v-if="post.images && post.images.length > 1" class="carousel-next" @click="nextImage(post)" aria-label="Next image">›</button>

                        <div v-if="post.images && post.images.length > 1" class="image-dots">
                            <span v-for="(img,i) in post.images" :key="i" :class="['dot', { active: i === (imageIndex[post.id] || 0) }]" @click="gotoImage(post, i)"></span>
                        </div>
                    </div>
            ...
            <div class="col-lg-2 d-none d-lg-block">
                <div class="position-sticky right-sidebar" >
                    <!-- Profile summary -->
                    ...
                    <div class="small text-muted">
                        Giới thiệu • Trợ giúp • Báo chí • API • Việc làm • Quyền riêng tư • Điều khoản • Vị trí • Ngôn
                        ngữ
                        <br />
                        © 2025 • MyBlog from ASM
                    </div>
                </div>
            </div>
        </div>
...
const stories = [
    { id: 1, user: "wyn.anh", avatar: '/img11.jpg' },
...
@media (max-width: 767.98px) {
    .inline-icon-menu { display: none !important }
}
...
.post-image .carousel-prev { left: 12px }
.post-image .carousel-next { right: 12px }
.post-image .carousel-prev:hover, .post-image .carousel-next:hover { background: rgba(0,0,0,0.65) }
...
.post-image .dot { width:8px; height:8px; background: rgba(255,255,255,0.5); border-radius:50%; cursor:pointer }
.post-image .dot.active { background:#fff }
