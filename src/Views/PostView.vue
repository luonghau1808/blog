              ...
              <div class="p-3 border-bottom d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  <div class="position-relative me-3">
                    <img :src="post.userAvatar || '/img01.jpg'" class="rounded-circle border" width="42" height="42" style="object-fit:cover;" />
                  </div>
                ...
                <div class="d-flex align-items-center mb-2">
                  <div class="d-flex gap-3">
                      <button class="btn btn-link p-0 text-dark" @click="toggleLike">
                        ...
                        <svg v-else aria-label="Bỏ thích" class="x1lliihq x1n2onr6 x5n08af" fill="#ff3040" height="24" role="img" viewBox="0 0 48 48" width="24">
                  ...
                  <div class="ms-auto">
                      <button class="btn btn-link p-0 text-dark" @click="toggleBookmark">
                        <svg v-if="!post.bookmarked" aria-label="Lưu" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
